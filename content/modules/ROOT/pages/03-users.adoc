...
+
image::users/hostedcluster_resource.png[link=self, window=blank, width=100%]
...
+
image::users/return_all_clusters.png[link=self, window=blank, width=100%]

. From the list of clusters that appear, click on *my-hosted-cluster*. Then scroll down to the *Details* section.
+
image::users/all_clusters_list.png[link=self, window=blank, width=100%]
...
+
image::users/skip_tour.png[link=self, window=blank, width=100%]
