...
.. Use the *Filter by kind* box to search for the term *HostedCluster*. It should return two values, click on the one that shows its version as *v1beta1*.
+
...
.. Return to *Infrastructure -> Clusters -> my-hosted-cluster*
